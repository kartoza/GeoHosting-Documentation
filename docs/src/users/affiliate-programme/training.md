...
1. From <span class="ui-page-label">Training → Sessions</span> click <span class="ui-generic-label">New session</span>.
...
From <span class="ui-page-label">Cohorts → Open</span> click <span class="ui-generic-label">Propose cohort</span>:
