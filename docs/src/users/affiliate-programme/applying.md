...
<!-- TODO: take-screenshots can't capture this view yet — the SPA crashes the headless browser within ms of /#/affiliate-apply loading with auth. See affiliate.spec.ts for the disabled test cases. -->
<div class="image-with-caption" style="display:none">
